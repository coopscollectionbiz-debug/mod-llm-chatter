...
def build_player_response_prompt(
    ...
    if is_rp:
        ...
        prompt += (
            ...
            "naturally ask one, but do not force them\n"
...
def build_player_msg_conversation_prompt(
    ...
    if is_rp:
        ...
        parts.append(
            ...
            "may be improvised naturally when consistent with prior chat\n"
            "- Do not make a speaker say they don't know merely because a "
            "harmless conversational answer is absent from live state\n"
            ...
            "- If the player asked a question, answer it directly\n"
            ...
            "- Brief or mundane answers are valid when appropriate, "
            "but do not use 'idk', 'lol', or 'not sure' as automatic "
            "fallbacks when the existing conversation supports a better "
            "response\n"
